...
class Renderer:
    def __init__(self, mesh_vertices, mesh_faces, mesh_uvs, mesh_face_uvs_idx):
        self.mesh_vertices = mesh_vertices
        self.mesh_faces = mesh_faces
        self.mesh_uvs = mesh_uvs
        self.mesh_face_uvs_idx = mesh_face_uvs_idx

    def get_camera_from_views(self, elev, azim, r):
